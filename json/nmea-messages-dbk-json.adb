...
package body NMEA.Messages.DBK.JSON is
   ...
   --  DBK_Message
   ----------------------------------------------------
   procedure Populate (Val : DBK_Message; Target : in out JSON_Value) is
   begin
   ...
   function Create (Val : DBK_Message) return JSON_Value is
   begin
   ...
   function Get (Val : GNATCOLL.JSON.JSON_Value) return DBK_Message is
   begin
      return Ret : DBK_Message do
         Map (Val, Ret);
      end return;
   end Get;
   ...
   -- Map_Field --
   ---------------
   procedure Map_Field (Name : UTF8_String; Value : JSON_Value; To : in out DBK_Message) is
   begin
