...
package body NMEA.Messages.DBT.JSON is
   ...
   --  DBT_Message
   ----------------------------------------------------
   procedure Populate (Val : DBT_Message; Target : in out JSON_Value) is
   begin
   ...
   function Create (Val : DBT_Message) return JSON_Value is
   begin
   ...
   function Get (Val : GNATCOLL.JSON.JSON_Value) return DBT_Message is
   begin
      return Ret : DBT_Message do
         Map (Val, Ret);
      end return;
   end Get;
   ...
   -- Map_Field --
   ---------------
   procedure Map_Field (Name : UTF8_String; Value : JSON_Value; To : in out DBT_Message) is
   begin
