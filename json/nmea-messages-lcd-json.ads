...
package NMEA.Messages.LCD.JSON is
   ...
   function Get (Val : JSON_Value; Field : UTF8_String) return LCD_Message;
   procedure Set_Field  (Val        : JSON_Value;  Field_Name : UTF8_String; Field  : LCD_Message);
   procedure Map (Val : JSON_Value; To : in out LCD_Message);
