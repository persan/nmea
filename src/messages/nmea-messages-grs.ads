...
package NMEA.Messages.GRS is
   type GRS_Message is new Message with record
      ...
      Residuals_Used                : NMEA_Dummy_Field;
      Satellite_1_Residual          : NMEA_Dummy_Field;
      Satellite_2_Residual          : NMEA_Dummy_Field;
      Satellite_3_Residual          : NMEA_Dummy_Field;
      Satellite_4_Residual          : NMEA_Dummy_Field;
      Satellite_5_Residual          : NMEA_Dummy_Field;
      Satellite_6_Residual          : NMEA_Dummy_Field;
      Satellite_7_Residual          : NMEA_Dummy_Field;
      Satellite_8_Residual          : NMEA_Dummy_Field;
      Satellite_9_Residual          : NMEA_Dummy_Field;
      Satellite_10_Residual         : NMEA_Dummy_Field;
      Satellite_11_Residual         : NMEA_Dummy_Field;
      Satellite_12_Residual         : NMEA_Dummy_Field;
   end record;
