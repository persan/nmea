...
package NMEA.Messages.TPC is
   type TPC_Message is new Message with record
      Horizontal_Distance_From_The_Vessel_Center_Line : NMEA_Dummy_Field;
      Meters                                          : NMEA_Dummy_Field;
      Horizontal_Distance_From_The_Transducer         : NMEA_Dummy_Field;
      Meters8                                         : NMEA_Dummy_Field;
      Depth_Of_The_Trawl_Below_The_Surface            : NMEA_Dummy_Field;
      Meters10                                        : NMEA_Dummy_Field;
   end record;
