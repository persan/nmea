...
package body NMEA.Messages.Latitude_Type_Test_Data.Latitude_Type_Tests.Suite is

   package Runner_1 is new AUnit.Test_Caller
     (GNATtest_Generated.GNATtest_Standard.NMEA.Messages.Latitude_Type_Test_Data.Latitude_Type_Tests.Test_Latitude_Type);
   ...
   begin
      ...
      Runner_1.Create
        (Case_1_1_Test_Read_7e055c,
         "nmea-messages.ads:120:4:",
         Test_Read_7e055c'Access);
      Runner_1.Create
        (Case_2_1_Test_Write_6fb053,
         "nmea-messages.ads:123:4:",
         Test_Write_6fb053'Access);
      Runner_1.Create
        (Case_1i_1_Test_Image_708c3f,
         "nmea-messages.ads:78:4: inherited at nmea-messages.ads:117:4:",
...
end NMEA.Messages.Latitude_Type_Test_Data.Latitude_Type_Tests.Suite;
--  end read only
