...
package body NMEA.Messages.NMEA_Field_Test_Data.NMEA_Field_Tests.Suite is
...
end NMEA.Messages.NMEA_Field_Test_Data.NMEA_Field_Tests.Suite;
--  end read only
