...
package body NMEA.Messages.NMEA_Integer_Test_Data.NMEA_Integer_Tests.Suite is
...
end NMEA.Messages.NMEA_Integer_Test_Data.NMEA_Integer_Tests.Suite;
--  end read only
