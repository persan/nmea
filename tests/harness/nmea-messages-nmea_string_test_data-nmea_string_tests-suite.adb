...
package body NMEA.Messages.NMEA_String_Test_Data.NMEA_String_Tests.Suite is

   package Runner_1 is new AUnit.Test_Caller
     (GNATtest_Generated.GNATtest_Standard.NMEA.Messages.NMEA_String_Test_Data.NMEA_String_Tests.Test_NMEA_String);
...
end NMEA.Messages.NMEA_String_Test_Data.NMEA_String_Tests.Suite;
--  end read only
