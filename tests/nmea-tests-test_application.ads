...
package NMEA.Tests.Test_Application is
   ...
   procedure On_RME (Self    : Application;
                     Message : NMEA.Messages.RME.RME_Message);
   ...
   procedure On_RMZ (Self    : Application;
                     Message : NMEA.Messages.RMZ.RMZ_Message);
   ...
   procedure On_CGA (Self    : Application;
                     Message : NMEA.Messages.CGA.CGA_Message);
   ...
   procedure On_RMM (Self    : Application;
                     Message : NMEA.Messages.RMM.RMM_Message);
   ...
   procedure On_VDM (Self    : Application;
                     Message : NMEA.Messages.VDM.VDM_Message);
   ...
   procedure On_VDO (Self    : Application;
                     Message : NMEA.Messages.VDO.VDO_Message);
