...
package body NMEA.Messages.Heading_Type_Test_Data is

   Local_Heading_Type : aliased GNATtest_Generated.GNATtest_Standard.NMEA.Messages.Heading_Type;
   procedure Set_Up (Gnattest_T : in out Test_Heading_Type) is
   begin
     GNATtest_Generated.GNATtest_Standard.NMEA.Messages.NMEA_Long_Float_Test_Data.NMEA_Long_Float_Tests.Test_NMEA_Long_Float(Gnattest_T).Set_Up;
      Gnattest_T.Fixture := Local_Heading_Type'Access;
   end Set_Up;

   procedure Tear_Down (Gnattest_T : in out Test_Heading_Type) is
   begin
